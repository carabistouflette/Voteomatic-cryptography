...
/**
 * Generic interface for abstracting data input/output operations. Defines contracts for reading and
 * writing raw byte data from/to specified locations (which could represent file paths, network
 * endpoints, database keys, etc.).
 */
public interface DataHandler {

  /**
   * Writes the given byte data to a specified destination. The interpretation of 'destination'
   * depends on the implementation (e.g., file path).
   *
  ...
  /**
   * Reads byte data from a specified source. The interpretation of 'source' depends on the
   * implementation (e.g., file path).
   *
