...
/**
 * Marker interface for a public key used for verifying digital signatures.
 * Concrete implementations will hold the specific key material for a given
 * signature algorithm (e.g., RSA public exponent and modulus, ECDSA public point).
...
public interface PublicVerificationKey {
     ...
     * Should match the algorithm of the corresponding PrivateSigningKey.
     *
    ...
    /**
     * Gets the encoded form of the public key.
     * Useful for serialization or transport. The format depends on the implementation.
     *
