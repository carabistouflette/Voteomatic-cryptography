...
/**
 * Represents a vote after it has been encrypted. Contains the ElGamal ciphertext and optionally an
 * associated Zero-Knowledge Proof (e.g., proving the vote is valid without revealing its content).
 */
public class EncryptedVote implements Serializable {
  ...
  public EncryptedVote(Ciphertext voteCiphertext, Proof validityProof) {
    // Objects.requireNonNull(voteCiphertext, "Vote ciphertext cannot be null"); // Removed for
    // testing
  ...
  public String toString() {
    return "EncryptedVote{"
        ...
        + voteCiphertext
        + ", validityProof="
        + (validityProof != null ? "present" : "absent")
        + '}';
  }
}
