...
/**
 * Represents the actual content of a vote cast by a voter. This structure should be simple and
 * serializable. The specific content (e.g., candidate ID, choice) depends on the election type.
 */
public class Vote implements Serializable {
   ...
   *
   * @param selectedOption The option chosen by the voter (e.g., candidate name/ID). Must not be
   *     null.
   */
  public Vote(String selectedOption) {
    // Objects.requireNonNull(selectedOption, "Selected option cannot be null"); // Removed for
    // testing
