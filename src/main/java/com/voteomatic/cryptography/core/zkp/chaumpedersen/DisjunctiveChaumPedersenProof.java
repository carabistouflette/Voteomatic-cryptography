...
/**
 * Represents the proof generated by the Disjunctive Chaum-Pedersen prover. It contains components
 * for both potential branches (v=0 and v=1) of the proof.
 *
 * <p>The proof consists of commitments (a0, b0, a1, b1) and challenge-responses (c0, r0, c1, r1)
 * for both potential branches (v=0 and v=1) of the proof. The verifier recalculates the overall
 * challenge c = H(...) and checks c = c0 + c1 mod q. Note: c = c0 + c1 (mod q), where q is the
 * group order.
 */
