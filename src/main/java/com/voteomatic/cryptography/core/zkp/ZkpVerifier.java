...
/**
 * Interface for verifying Zero-Knowledge Proofs (ZKPs).
 * Defines the contract for a verifier component that can check the validity
 * of a proof with respect to a public statement, without learning the secret witness.
 *
...
public interface ZkpVerifier<S extends Statement, P extends Proof> {
     ...
     * @throws ZkpException if verification fails due to an error (e.g., incompatible types, internal errors).
     */
