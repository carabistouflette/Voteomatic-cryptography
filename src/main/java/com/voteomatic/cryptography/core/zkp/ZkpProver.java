...
/**
 * Interface for generating Zero-Knowledge Proofs (ZKPs).
 * Defines the contract for a prover component that can generate a proof
 * demonstrating knowledge of a secret (witness) related to a public statement,
