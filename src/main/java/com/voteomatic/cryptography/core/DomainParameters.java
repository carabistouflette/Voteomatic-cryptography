...
/**
 * Represents the cryptographic domain parameters (p, g, q) for Diffie-Hellman based schemes like ElGamal.
...
public final class DomainParameters {
     ...
     * should be performed *before* constructing this object, typically when
     * loading or generating parameters externally.
     *
    ...
    public String toString() {
        ...
        return "DomainParameters{" +
               "p=..." + // p.toString().substring(0, Math.min(p.toString().length(), 10)) + "..." +
               ", g=" + g + // g is usually small
               ", q=..." + // q.toString().substring(0, Math.min(q.toString().length(), 10)) + "..." +
               '}';
    }
}