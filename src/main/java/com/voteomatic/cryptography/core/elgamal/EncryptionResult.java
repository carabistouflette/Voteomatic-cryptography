...
/**
 * Holds the result of an ElGamal encryption operation, including the ciphertext
...
public class EncryptionResult {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(ciphertext, that.ciphertext) && Objects.equals(randomness, that.randomness);
    }
    ...
    public String toString() {
        return "EncryptionResult{" +
               ...
               ", randomness=" + randomness + // Be cautious about logging randomness in production
               '}';
    }
}