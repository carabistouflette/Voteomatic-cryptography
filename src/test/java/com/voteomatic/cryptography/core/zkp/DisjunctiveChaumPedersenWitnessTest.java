...
class DisjunctiveChaumPedersenWitnessTest {
    ...
    void constructor_validInputV0_success() {
        DisjunctiveChaumPedersenWitness witness = new DisjunctiveChaumPedersenWitness(sampleR, 0);
    ...
    void constructor_validInputV1_success() {
        DisjunctiveChaumPedersenWitness witness = new DisjunctiveChaumPedersenWitness(sampleR, 1);
        assertNotNull(witness);
        assertEquals(sampleR, witness.getR());
    ...
    void constructor_nullR_throwsNullPointerException() {
        NullPointerException exception = assertThrows(NullPointerException.class, () -> {
            new DisjunctiveChaumPedersenWitness(null, 0);
        });
    ...
    void constructor_invalidV_throwsIllegalArgumentException() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            new DisjunctiveChaumPedersenWitness(sampleR, 2); // Invalid v
        });
        assertEquals("Message index v must be 0 or 1", exception.getMessage());

        exception = assertThrows(IllegalArgumentException.class, () -> {
            new DisjunctiveChaumPedersenWitness(sampleR, -1); // Invalid v
        });
        assertEquals("Message index v must be 0 or 1", exception.getMessage());
    }
    ...
    void getV_returnsCorrectValue() {
        DisjunctiveChaumPedersenWitness witness0 = new DisjunctiveChaumPedersenWitness(sampleR, 0);
        assertEquals(0, witness0.getV());
        DisjunctiveChaumPedersenWitness witness1 = new DisjunctiveChaumPedersenWitness(sampleR, 1);
    ...
    void equals_equalObjects_returnsTrue() {
        DisjunctiveChaumPedersenWitness witness1 = new DisjunctiveChaumPedersenWitness(sampleR, 0);
        DisjunctiveChaumPedersenWitness witness2 = new DisjunctiveChaumPedersenWitness(sampleR, 0);
    ...
    void equals_differentR_returnsFalse() {
        DisjunctiveChaumPedersenWitness witness1 = new DisjunctiveChaumPedersenWitness(sampleR, 0);
        DisjunctiveChaumPedersenWitness witness2 = new DisjunctiveChaumPedersenWitness(BigInteger.TEN, 0);
    ...
    void equals_differentV_returnsFalse() {
        DisjunctiveChaumPedersenWitness witness1 = new DisjunctiveChaumPedersenWitness(sampleR, 0);
        DisjunctiveChaumPedersenWitness witness2 = new DisjunctiveChaumPedersenWitness(sampleR, 1);
        assertFalse(witness1.equals(witness2));
    }
