...
class EncryptionResultTest {
    ...
    @BeforeEach
    void setUp() {
        mockCiphertext = new Ciphertext(BigInteger.valueOf(123), BigInteger.valueOf(456)); // Use concrete instance
    ...
    void equals_equalObjects_returnsTrue() {
        EncryptionResult otherResult = new EncryptionResult(
    ...
    void equals_differentRandomness_returnsFalse() {
        EncryptionResult otherResult = new EncryptionResult(
            mockCiphertext,
            BigInteger.TEN // Different randomness
        );
        assertFalse(encryptionResult.equals(otherResult));
    }
