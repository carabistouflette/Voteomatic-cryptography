...
class CiphertextTest {
  ...
  void constructorAndGetters_ValidInput_ShouldSucceed() {
    ...
    assertEquals(
        c1, ciphertext.getC1(), "getC1 should return the value passed to the constructor.");
    assertEquals(
        c2, ciphertext.getC2(), "getC2 should return the value passed to the constructor.");
  }
  ...
  void equals_DifferentType_ShouldReturnFalse() {
    ...
    assertFalse(
        ct1.equals(other), "An object should not be equal to an object of a different type.");
  }
  ...
  void hashCode_DifferentObjects_HashCodesMayDiffer() {
    ...
    assertNotEquals(
        ct1.hashCode(), ct2.hashCode(), "Hash code should likely differ if c1 differs.");
    assertNotEquals(
        ct1.hashCode(), ct3.hashCode(), "Hash code should likely differ if c2 differs.");
  }
