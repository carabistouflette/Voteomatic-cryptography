...
class PublicKeyTest {
  ...
  void constructorAndGetters_ValidInput_ShouldSucceed() {
    ...
    assertEquals(
        params, publicKey.getParams(), "getParams should return the DomainParameters object.");
  ...
  void hashCode_DifferentObjects_HashCodesMayDiffer() {
    ...
    assertNotEquals(
        key1.hashCode(), key4.hashCode(), "Hash code should likely differ if y differs.");
  }
