...
class PrivateKeyTest {
  ...
  void constructorAndGetters_ValidInput_ShouldSucceed() {
    ...
    assertEquals(
        params, privateKey.getParams(), "getParams should return the DomainParameters object.");
  ...
  void equals_DifferentParamsP_ShouldReturnFalse() {
    ...
    DomainParameters params2 =
        new DomainParameters(
            p2_val,
            g_val,
            p2_val.subtract(BigInteger.ONE).divide(BigInteger.TWO)); // Different params
    PrivateKey key1 = new PrivateKey(params, x_val);
    PrivateKey key2 = new PrivateKey(params2, x_val);
    assertFalse(
        key1.equals(key2), "Objects with different params (different p) should not be equal.");
  }
  ...
  void equals_DifferentParamsG_ShouldReturnFalse() {
    ...
    PrivateKey key2 = new PrivateKey(params2, x_val);
    assertFalse(
        key1.equals(key2), "Objects with different params (different g) should not be equal.");
  }
  ...
  void equals_DifferentType_ShouldReturnFalse() {
    ...
    assertFalse(
        key1.equals(other), "An object should not be equal to an object of a different type.");
  }
  ...
  void hashCode_DifferentObjects_HashCodesMayDiffer() {
    ...
    DomainParameters params2_p =
        new DomainParameters(p2_val, g_val, p2_val.subtract(BigInteger.ONE).divide(BigInteger.TWO));
    ...
    assertNotEquals(
        key1.hashCode(), key2.hashCode(), "Hash code should likely differ if params differ (p).");
    assertNotEquals(
        key1.hashCode(), key3.hashCode(), "Hash code should likely differ if params differ (g).");
    assertNotEquals(
        key1.hashCode(), key4.hashCode(), "Hash code should likely differ if x differs.");
  }
  ...
  void toString_ContainsFieldValuesAndRedactsX() {
    ...
    assertTrue(
        str.contains("params=" + params.toString()),
        "toString should contain the DomainParameters object string representation.");
