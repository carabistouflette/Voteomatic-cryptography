...
class PublicVerificationKeyImplTest {
    ...
    @Test
    void getEncoded_returnsCorrectEncoding() throws NoSuchAlgorithmException, InvalidKeySpecException {
        PublicVerificationKeyImpl verificationKey = new PublicVerificationKeyImpl(jcaPublicKey);
    ...
    void getEncoded_returnsNullWhenUnderlyingKeyEncodingIsNull() {
        ...
        // We also need to mock getAlgorithm() as it's called by the constructor indirectly via PublicVerificationKeyImpl constructor
        // (though not strictly necessary for testing getEncoded, it prevents potential NullPointerExceptions if the constructor logic changes)
