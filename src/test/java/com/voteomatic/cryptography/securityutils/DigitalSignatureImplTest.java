...
class DigitalSignatureImplTest {
    ...
    void setUp() throws SecurityUtilException {
        digitalSignature = new DigitalSignatureImpl(SIGNATURE_ALGORITHM);
    }
    ...
    void constructor_invalidAlgorithm_throwsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new DigitalSignatureImpl("InvalidAlgorithmName");
        });
    }
    ...
    void verify_invalidSignature_returnsFalse() throws SecurityUtilException {
        ...
        boolean isValid = digitalSignature.verify(data, signature, publicKey);
        // This covers the case where Signature.verify throws SignatureException, which is caught and returns false
    ...
    void verify_invalidData_returnsFalse() throws SecurityUtilException {
        ...
        // This also covers the case where Signature.verify throws SignatureException, which is caught and returns false
    ...
    void sign_signatureException_throwsSecurityUtilException() throws Exception {
        ...
        try (MockedStatic<Signature> mockedStaticSignature = Mockito.mockStatic(Signature.class)) {
            mockedStaticSignature.when(() -> Signature.getInstance(SIGNATURE_ALGORITHM))
    ...
    void sign_noSuchAlgorithm_throwsSecurityUtilException() throws Exception {
        byte[] data = "data".getBytes(StandardCharsets.UTF_8);
        NoSuchAlgorithmException noSuchAlgoEx = new NoSuchAlgorithmException("Simulated no such algorithm");
    ...
    void sign_keyAlgorithmMismatch_throwsException() throws NoSuchAlgorithmException {
     ...
     @Test
     void verify_keyAlgorithmMismatch_throwsException() throws NoSuchAlgorithmException, SecurityUtilException {
         // Create a key with a different algorithm (e.g., DSA)
         KeyPairGenerator dsaKeyGen = KeyPairGenerator.getInstance("DSA");
         dsaKeyGen.initialize(2048);
         KeyPair dsaKeyPair = dsaKeyGen.generateKeyPair();
    ...
    @Test
     void sign_corruptPrivateKey_throwsException() throws NoSuchAlgorithmException {
         ...
         PrivateKey badKey = new PrivateKey() {
             @Override
             public String getAlgorithm() { return corruptKey.getAlgorithm(); }
             @Override
             public String getFormat() { return corruptKey.getFormat(); }
             @Override
     ...
     @Test
     void verify_corruptPublicKey_throwsException() throws NoSuchAlgorithmException, SecurityUtilException {
     ...
     void signAndVerify_withECDSA_works() throws SecurityUtilException, NoSuchAlgorithmException {
         ...
         DigitalSignature ecdsaSignature = new DigitalSignatureImpl("SHA256withECDSA");
     ...
     void verify_nonRepudiation_property() throws SecurityUtilException {
         ...
         assertTrue(digitalSignature.verify(data, signature, publicKey),
         ...
         try {
             ...
             PublicVerificationKey otherPublicKey = new PublicVerificationKeyImpl(otherKeyPair.getPublic());
             
             // Verification should fail with different public key
             assertFalse(digitalSignature.verify(data, signature, otherPublicKey),
