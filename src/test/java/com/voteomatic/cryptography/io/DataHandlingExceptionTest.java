...
class DataHandlingExceptionTest {
    ...
    void testConstructorWithMessage() {
        ...
        assertEquals(TEST_MESSAGE, exception.getMessage(), "Exception message should match the one provided in the constructor.");
    ...
    void testConstructorWithNullMessage() {
        // Check if the constructor handles null message gracefully (it should inherit behavior from Exception)
        ...
        assertEquals(TEST_CAUSE, exception.getCause(), "Cause should still be set even with null message.");
    }
