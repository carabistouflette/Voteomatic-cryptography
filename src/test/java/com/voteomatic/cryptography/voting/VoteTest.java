...
class VoteTest {
  ...
  void constructorAndGetter_ValidInput_ShouldSucceed() {
    ...
    assertEquals(
        ...
        "getSelectedOption should return the value passed to the constructor.");
  }
  ...
  void equals_DifferentType_ShouldReturnFalse() {
    ...
    assertFalse(
        vote1.equals(other), "An object should not be equal to an object of a different type.");
  }
  ...
  void toString_ContainsRedactedValue() {
    ...
    assertTrue(
        str.contains("selectedOption='[REDACTED]'"),
        "toString should contain '[REDACTED]' for the option.");
