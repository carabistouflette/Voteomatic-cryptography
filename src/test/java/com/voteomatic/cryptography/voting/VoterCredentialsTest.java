...
class VoterCredentialsTest {
    ...
    void constructorAndGetter_ValidInput_ShouldSucceed() {
        ...
        assertEquals(voterId, credentials.getVoterId(), "getVoterId should return the value passed to the constructor.");
    }

    @Test
    void constructor_NullInput_ShouldThrowNullPointerException() {
        assertThrows(NullPointerException.class, () -> new VoterCredentials(null),
    ...
    void equals_DifferentType_ShouldReturnFalse() {
        ...
        assertFalse(creds1.equals(other), "An object should not be equal to an object of a different type.");
    }
    ...
    void hashCode_EqualObjects_ShouldHaveEqualHashCodes() {
        ...
        VoterCredentials creds1 = new VoterCredentials(voterId);
        VoterCredentials creds2 = new VoterCredentials(voterId); // Same value
        assertEquals(creds1.hashCode(), creds2.hashCode(), "Equal objects should have equal hash codes.");
    }
    ...
    void hashCode_DifferentObjects_ShouldHaveDifferentHashCodes() {
        ...
        assertNotEquals(creds1.hashCode(), creds2.hashCode(), "Hash codes for different objects should ideally differ.");
    }
    ...
    void toString_ContainsFieldValue() {
        ...
        assertTrue(str.contains("voterId='" + voterId + "'"), "toString should contain the voterId field and value.");
